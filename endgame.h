...
enum EndgameType {
  ...
  STARTNEW
  // endgame patterns from 
  // Atomic Chess: Elementary Endgames by Leonard Blackburn (Rekursiv)
  KQK_ATOMIC,			// KQ vs K
  KRK_ATOMIC,			// KQ vs K
  KQXsK_ATOMIC,			// KQ+any vs K
  KRRK_ATOMIC,			// KRR vs K
  KRBK_ATOMIC,			// KRB vs K
  KRNK_ATOMIC,			// KRN vs K
  KQKP_ATOMIC,			// KQ vs KP
  KQPKP_ATOMIC,			// KQP vs KP
  KRPKP_ATOMIC,			// KRP vs KP
  KPsKPs_ATOMIC,		// K+pawns vs K+pawns
  KXKP_ATOMIC,			// K+piece vs KP
  PAWNITIZATION_ATOMIC,	// Pawnitization
